...
def generate_paths(x_train_dir, y_train_dir,
    ...
    ext = ['png', 'jpg']
    train_img_paths = []
    [train_img_paths.extend(glob.glob(os.path.join(x_train_dir, "*." + e))) for e in ext]

    val_img_paths = []
    [val_img_paths.extend(glob.glob(os.path.join(x_val_dir, "*." + e))) for e in ext]

    test_img_paths = []
    [test_img_paths.extend(glob.glob(os.path.join(x_test_dir, "*." + e))) for e in ext]
